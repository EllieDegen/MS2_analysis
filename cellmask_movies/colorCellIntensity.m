% myfile = '/Users/izze/Documents/Projects/imaging_data/oddlate_ms2/201117_oddlatems2_1xmcpGFP4F_1xHRFP_2_analysis/initial_analysis';
...
savedir='/Users/ellie/Documents/MATLAB/Ellie/MS2_Gal4/kni64_200Hz_noOverview/kni64_201116';
saveMovieFx([savedir, filesep, 'mcp_cells'], mcp_cells);
saveMovieFx([savedir, filesep, 'acc_mcp_cells'], acc_mcp_cells);
saveMovieFx([savedir, filesep, 'mcp_cells_noTracking'], mcpCellFill);

%% Save histone and ms2DOG
histone=squeeze(sum(test.histoneRFP,3));
histone=histone./max(histone(:));
saveMovieFx([savedir, filesep, 'histone'],histone);

ms2DOG=squeeze(sum(test.ms2DOG,3));
ms2DOG=ms2DOG./max(ms2DOG(:));
saveMovieFx([savedir, filesep, 'ms2DOG'],ms2DOG);
